...
const Signup = () => {
    ...
    *========================================================================**/
    ...
    return (
        <div className='flex justify-center items-center h-screen bg-gradient-to-l from-brown-300 to-brown-500'>
            {loading && <Loader/>}
            {/* Login Form  */}
            <div className="login_Form bg-pink-50 px-8 py-6 border-2 hover:shadow-2xl hover:shadow-gray-900 border-gray-300  bg-gradient-to-l from-brown-400 to-brown-700   rounded-xl shadow-md">
                ...
                <div className="mb-3">
                    <input
                        ...
                        className='bg-pink-50 border border-pink-200 px-2 py-2 w-96 rounded-md outline-none placeholder-gray-500'
                    />
                </div>
