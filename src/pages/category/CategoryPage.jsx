    ...
    return (
        <Layout>
            <div className="mt-10">
                {/* Heading  */}
                <div className="">
                    <h1 style={{ color: mode === 'dark' ? 'white' : '', }}   className=" text-center mb-5 text-3xl font-semibold first-letter:uppercase">{categoryname}</h1>
                </div>
                        ...
                        <section className="text-gray-600 body-font">
                            ...
                            return (
                                <div key={index} className="p-4 w-full md:w-1/4">
                                    <div className="h-ful bg-brown-400 border-2 hover:shadow-2xl hover:shadow-gray-500 border-gray-200  rounded-xl overflow-hidden shadow-md cursor-pointer">
                                        <img
