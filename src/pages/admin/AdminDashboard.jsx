    ...
    return (
        <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className=" bg-gradient-to-l from-brown-300 to-brown-500 py-5 border border-pink-100 rounded-lg">
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border-2 hover:shadow-2xl hover:shadow-gray-500 border-gray-200  bg-gradient-to-l from-brown-300 to-brown-500   px-4 py-3 rounded-xl" >
