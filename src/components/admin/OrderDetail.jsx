    ...
    return (
        <div>
            <div>
                <div className="py-5">
                    {/* text  */}
                    <h1 style={{ color: mode === 'dark' ? 'white' : '', }}  className=" text-xl text-black font-bold">All Order</h1>
                </div>

                {/* table  */}
                <div className="w-full overflow-x-auto">
                    <table style={{ color: mode === 'dark' ? 'white' : '', }}  className="w-full text-left border border-collapse sm:border-separate border-pink-100 text-black" >
                        <tbody>
                            <tr>
